...
export const useBudgetTransactions = (uuid: string): Response<TransactionResponse[]> => {
...
export const useAccountUsage = (uuid: string): Response<AccountUsage> => {
...
export const useCategoryTransactions = (uuid: string): Response<TransactionResponse[]> => {
...
export const useTransaction = (uuid: string): Response<TransactionResponse> => {
