  ...
  return (
    ...
    >
      <RadioPrimitive.Indicator
        className="data-checked:bg-primary before:bg-primary-foreground absolute -inset-px flex size-4.5 items-center justify-center rounded-full before:size-2 before:rounded-full data-unchecked:hidden sm:size-4 sm:before:size-1.5"
